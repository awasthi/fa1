...
\label{sec:orgb53864f}

\subsection{Examples of metric spaces}
\label{sec:org2bd34cc}

\subsubsection{The set of continuous functions \(C[a, b]\)}
\label{sec:org8d3032a}
...
\label{sec:orge089586}
\subsubsection{Definition of a norm}
\label{sec:org197364a}
\subsubsection{Examples}
\label{sec:orga48f78a}
\begin{enumerate}
\item \(\R^n\)
...
\label{sec:orge570088}
\subsection{Remark}
\label{sec:org53a191c}
...
\label{sec:orga975372}
\section{Lecture 5 \textit{<2018-11-01 Thu>}}
\label{sec:org81c980e}
\subsection{Review}
\label{sec:org5a466d1}
...
\(Y\).
\subsubsection{Proof}
\label{sec:orgb982540}
Proof is easy.
\subsection{Corollary}
\label{sec:org2bf70ce}
...
\label{sec:orgce2e56a}
\subsection{Example}
\label{sec:org2e9f795}
...
\label{sec:org9c775bc}
\subsection{About finite linear operators}
\label{sec:orgfe06403}
...
\label{sec:org546dc65}
\subsection{Koopman operator}
\label{sec:org6ecdf51}
\(Kf = f\circ I\)
...
\label{sec:org15f4119}
\subsection{About \(l^p\) and \(l^q\)}
\label{sec:org90c71ce}
...
\label{sec:org4d8a62e}
\subsection{Theorem}
\label{sec:org500833f}
...
\label{sec:orgaf84115}
\subsection{Adjoint operators}
\label{sec:orgdf78a15}
...
\label{sec:org3a11ce8}
\subsubsection{Example 1}
\label{sec:orgc3e0752}
...
\section{Homeworks}
\label{sec:orgb2ae5e7}
\subsection{Homework 8}
\label{sec:orgc53c5ae}
\subsubsection{8.1}
\label{sec:org9401f08}
